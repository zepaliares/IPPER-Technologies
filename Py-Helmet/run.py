...
#def alterar_valor_booleano():
    ...
    # Executar o comando de atualização com o novo valor
    #cursor.execute("UPDATE usuario SET cap = 1 WHERE nome IN ('gabriel', 'tupan')")
