...
import camera
from conexao import sem_capacete
from conexao import com_capacete
...
class helmet_detection():
    def __init__(self):
        ...
        self.inpWidth = 460       #Width of network's input image
        self.inpHeight = 460   #Height of network's input image
